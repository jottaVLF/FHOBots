...
void SimVision::detectionColors(){
    ...
    if(nbytes > 0){
        // Parsing dos dados recebidos por rede
        ...
        // Atualizar a posição dos times
        if(this->config->teamColor == "blue"){
            //Attacker
            Global::attacker.setPosition(toPixelX(environment.frame().robots_blue(0).x()), toPixelY(environment.frame().robots_blue(0).y()));
            setOrientationVector(&Global::attacker, environment.frame().robots_blue(0).orientation());
            //Deffender
            ...
            //Goalkeeper
            Global::goalkeeper.setPosition(toPixelX(environment.frame().robots_blue(2).x()), toPixelY(environment.frame().robots_blue(2).y()));
            setOrientationVector(&Global::goalkeeper, environment.frame().robots_blue(2).orientation());
            ...
            //Attacker
            Global::attacker.setPosition(toPixelX(environment.frame().robots_yellow(0).x()), toPixelY(environment.frame().robots_yellow(0).y()));
            setOrientationVector(&Global::attacker, environment.frame().robots_yellow(0).orientation());
            //Deffender
            ...
            //Goalkeeper
            Global::goalkeeper.setPosition(toPixelX(environment.frame().robots_yellow(2).x()), toPixelY(environment.frame().robots_yellow(2).y()));
            setOrientationVector(&Global::goalkeeper, environment.frame().robots_yellow(2).orientation());
...
void SimVision::adjustFieldPosition(){
    ...
    if(this->config->teamColor == "blue"){
        ...
        Global::eAreaAttack  = AREA_DEFFEND_LEFT;
