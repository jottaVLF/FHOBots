...
void Debug::show(){
    ...
    drawField3v3();
    cv::circle(this->debug, cv::Point(Global::ball.x, Global::ball.y), 2, cv::Scalar(0, 60, 255), 5);
...
cv::Point Debug::toPixel(double x, double y){
    return cv::Point(toPixelX(x), toPixelY(y));
}
...
void Debug::drawRobot(Robot * robot, bool isFhobotsYellow){
    ...
    cv::putText(this->debug, id, cv::Point(robot->getPosition().x - 15, robot->getPosition().y - 15),
                cv::FONT_HERSHEY_COMPLEX_SMALL, 0.6, cv::Scalar(255,255, 255));
...
void Debug::drawField3v3(){
    cv::line(this->debug, toPixel(0, 0.65), toPixel(0, -0.65), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(0.75, 0.65), toPixel(0.75, -0.65), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(-0.75, 0.65), toPixel(-0.75, -0.65), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(0.75, 0.22), toPixel(0.85, 0.22), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(0.75, -0.22), toPixel(0.85, -0.22), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(-0.75, 0.22), toPixel(-0.85, 0.22), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(-0.75, -0.22), toPixel(-0.85, -0.22), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(0.75, 0.35), toPixel(0.6, 0.35), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(0.75, -0.35), toPixel(0.6, -0.35), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(0.6, 0.35), toPixel(0.6, -0.35), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(-0.75, 0.35), toPixel(-0.6, 0.35), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(-0.75, -0.35), toPixel(-0.6, -0.35), cv::Scalar(255, 255, 255));
    cv::line(this->debug, toPixel(-0.6, 0.35), toPixel(-0.6, -0.35), cv::Scalar(255, 255, 255));
