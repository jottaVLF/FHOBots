...
enum Foul : int {
  ...
  STOP = 5,
  GAME_ON = 6,
  Foul_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Foul_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum Quadrant : int {
  ...
  QUADRANT_3 = 3,
  QUADRANT_4 = 4,
  Quadrant_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Quadrant_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline ::VSSRef::Robot* Frame::add_robots() {
  ::VSSRef::Robot* _add = _internal_add_robots();
