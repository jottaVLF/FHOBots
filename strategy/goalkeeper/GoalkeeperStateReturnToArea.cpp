...
void GoalkeeperStateReturnToArea::doActions() 
{
        ...
        Global::communication->writeMessage(_robot->getPosMessage(),  _robot->getPwmLeft(), _robot->getPwmRight(), false, false);
        //Global::communication->writeMessage(_robot->getPosMessage(), 0, 100);
    }
...
void GoalkeeperStateReturnToArea::entryActions() {
    _robot->setPD(12, 60); ///180.5, -950.35
